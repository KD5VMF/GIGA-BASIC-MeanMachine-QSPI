...
/*
 * GIGA BASIC MEAN MACHINE REV11 FORCE ENABLE
 *
 * This package is a GIGA R1 WiFi-specific build. The onboard QSPI flash
 * user-data partition is used as the BASIC filesystem through LittleFS.
 * These defines MUST be outside the large commented-out option list below.
 */
...
/* Arduino GIGA R1 WiFi onboard QSPI LittleFS storage.
 * REV11 force-enables this above; these compatibility checks help if this file
 * is reused outside the REV11 package.
 */
#if defined(ARDUINO_ARCH_MBED_GIGA) || defined(ARDUINO_GIGA) || defined(ARDUINO_GIGA_R1_WIFI)
#ifndef GIGAQSPIFS
#define GIGAQSPIFS
#endif
#ifndef GIGAQSPIFS_VERBOSE
#define GIGAQSPIFS_VERBOSE
#endif
#endif
...
/* Arduino GIGA R1 WiFi onboard QSPI user-data LittleFS filesystem. */
#ifdef GIGAQSPIFS
#define FILESYSTEMDRIVER
#endif
